                      ...
                      _In_ int       nCmdShow)
{
	...
	swprintf(commandLine, ArraySize(commandLine), L"UELibraryProject.uproject %s %s", MapToUse.c_str(), CmdLineCopy.c_str());
	...
	if (int Error = UELibrary_Init(hInstance, hWnd, commandLine))
	{
